...
#
# Exports the tree at <sha>, diffs it against its first parent, runs steps 1, 2, 4, 5, 7 and 8
# (F01) in the sandbox image built from gate/Dockerfile for the graph's pinned toolchain — the
# image also carries the built Lean metaprograms steps 7-8 call (F01-R10) — and writes
