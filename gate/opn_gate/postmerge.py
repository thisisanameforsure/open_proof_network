...
def child_statement(child: str, hole: Any, *, imports: Sequence[str] = ()) -> str:
    """The child's ``Statement.lean``: the hole's obligation, closed over the binders it sat under,
    under the imports its parent's statement carries.
    ...
    the parent's own Context is not the child's (F01-Q2).
    """
