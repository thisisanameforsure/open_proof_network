"""Untrusted-data demarcation (F09-R6; D-28, D-31; C9). Since F10-T2 the rule lives here in the
gate, where the post-merge job applies it to ``CONTEXT.json``; the api re-exports it.
