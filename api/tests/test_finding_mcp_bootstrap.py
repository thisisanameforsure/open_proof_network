...
(both are existing endpoints, so the bijection holds). Each test asserts that behaviour; they
were held as strict xfails until F09-T6 landed, and the marks came off with it (conventions §2).
"""
